...
// 1. THE GATEKEEPER: Ensure only logged-in Super Admins can access this page
...
<head>
    ...
    <style>
        body { background: linear-gradient(180deg, #f6fff7 0%, #e9f8ff 100%); }
        .main-content { margin-left: 280px; min-height: 100vh; padding: 2rem; }
        .custom-card { background-color: rgba(255, 255, 255, 0.98); border: 1px solid #d8efd5; border-radius: 16px; }
        .page-title { color: #0b6d36; }
        .btn-create { background-color: #3f9f25; border-color: #3f9f25; color: white; }
        .btn-create:hover { background-color: #0b6d36; border-color: #0b6d36; color: white; }
        .table thead { background-color: #e6f6e7; }
        .badge-opisyal { background-color: #0d6efd; }
        .badge-sk { background-color: #fd7e14; }
    </style>
</head>
<body>
                ...
                <div class="custom-card p-4 shadow-sm h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead>
                                <tr><th>Name</th><th>Username</th><th>Role</th><th>Date Added</th><th class="text-center">Action</th></tr>
                            </thead>
                            <tbody>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($officials_result)): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-danger" title="Revoke Access"><i class="bi bi-dash-circle"></i></button>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="5" class="text-center py-4 text-muted">No official accounts have been created yet.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
